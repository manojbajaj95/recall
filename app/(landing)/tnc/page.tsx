  ...
  return (
    <div className="prose container mx-auto">
      ...
      <p>
        ...
        of {name}'s Website, located at {website}.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use {name} if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing {name}, you agreed to use
        cookies in agreement with the {name}'s Privacy Policy.{" "}
      </p>
      ...
      <p>
        ...
        intellectual property rights for all material on {name}. All
        intellectual property rights are reserved. You may access this from
        {name} for your own personal use subjected to restrictions set in these
      ...
      <p>
        ...
        {name} does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of {name},its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, {name} shall not be liable for the
      ...
      <p>
        You hereby grant {name} a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of {name}; and (d) the link is in
      ...
      <p>
        ...
        e-mail to {name}. Please include your name, your organization name,
      ...
      <p>
        No use of {name}'s logo or other artwork will be allowed for linking
