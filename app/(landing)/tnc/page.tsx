const tnc = () => {
  ...
  return (
    <div className="container prose mx-auto">
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of {name}'s Website, located at{' '}
        {website}.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use {name} if you
      ...
      <p>
        We employ the use of cookies. By accessing {name}, you agreed to use cookies in agreement with the {name}'s
        Privacy Policy.{' '}
      </p>
      ...
      <p>
        ...
        {name}. All intellectual property rights are reserved. You may access this from
      ...
      <p>
        ...
        {name} does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not
        reflect the views and opinions of {name},its agents and/or affiliates. Comments reflect the views and opinions
        of the person who post their views and opinions. To the extent permitted by applicable laws, {name} shall not be
        liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use
      ...
      <p>
        You hereby grant {name} a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
      ...
      <p>
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of {name};
      ...
      <p>
        ...
        you must inform us by sending an e-mail to {name}. Please include your name, your organization name, contact
