const privacy = () => {
  ...
  return (
    <div className="container prose mx-auto">
      ...
      <p>
        At {name}, accessible from {website}, one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and recorded by {name} and how we use it.
      </p>
      ...
      <p>
        {name} follows a standard procedure of using log files. These files log visitors when they visit websites. All
      ...
      <p>
        Like any other website, {name} uses 'cookies'. These cookies are used to store information including visitors'
      ...
      <p>
        ...
        in their respective advertisements and links that appear on {name}, which are sent directly to users' browser.
      ...
      <p>
        {name}'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
      ...
      <p>
        {name} does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
