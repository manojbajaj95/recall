const privacy = () => {
  ...
  return (
    <div className="prose container mx-auto">
      ...
      <p>
        At {name}, accessible from {website}, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by {name} and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in {name}. This policy is not applicable to any
      ...
      <p>
        {name} follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, {name} uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of {name}.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on {name}, which are sent directly
      ...
      <p>
        Note that {name} has no access to or control over these cookies that are
      ...
      <p>
        {name}'s Privacy Policy does not apply to other advertisers or websites.
